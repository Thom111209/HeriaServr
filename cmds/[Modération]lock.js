...
module.exports.run = async (bot, message, args) => {
  ...
  if (!message.guild.member(bot.user).hasPermission("ADMINISTRATOR")) return message.channel.send("Je n'ai pas la __permission:__ __**'ADMINISTRATEUR'**__, je ne peux donc pas *lock* le salon ")
        ...
        if(!args[0]){
            const hEmbed = new Discord.MessageEmbed()
                ...
                .setDescription(`**!lock off =** *Ferme le salon !*\n**!lock on =** *Ouvre le Salon !*`)
                .setTimestamp();
        ...
        if(lockAllOn){
            ...
            message.channel.send("`SUCCÈS\` Tout les salons on été ouvert.")
